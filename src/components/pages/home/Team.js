...
const Team = () => (
  <section className="team" id="team">
    ...
    <div className="box">
      <h2>Meet the Team</h2>
      <p>
        The research team at Kitsune Analytics come from a diverse set of research backgrounds but they all share
        one thing in common: their love for data!
      </p>

      <p>
        The Kitsune team offers a unique approach to analytics, as their diverse backgrounds allow them to draw together
